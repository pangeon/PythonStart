...
while(operation != "exit"):
    ...
    if(operation == "exit"):
        ...
        basefile_user = open("user_base.txt", "w")
        basefile_user.write((input("Wpisz nową notakę i zatwierdź (ENTER):\n Poprzedni plik zostanie nadpisany.")))
        basefile_user = open("user_base.txt", "r")
        i = 0
